    ...
    >
      ...
      >
        <div className="mb-2 flex items-start justify-between gap-2">
          <span className="font-mono text-xs text-slate-500">PO #{order.po_number}</span>
        ...
        <p className="mb-1 truncate text-sm font-medium text-slate-100" title={order.vendor ?? ''}>
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="shrink-0 text-right">
                      ...
                      <p className="tabular-nums text-sm font-medium text-slate-100">
                        {formatQty(
                          item.qty_ordered ??
